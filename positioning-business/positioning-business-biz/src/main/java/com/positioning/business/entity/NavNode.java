 ...
 */
@Schema(description = "导航节点表: 通道点、岔路口、门、电梯口、车位入口、商铺入口等")
@Data
@TableName("nav_node")
public class NavNode {

    /** 节点ID（雪花ID，应用层生成） */
    @Schema(description = "节点ID（雪花ID，应用层生成）")
    ...
    @Schema(description = "节点类型: WAYPOINT=通道点 JUNCTION=岔路口 DOOR=门 ELEVATOR=电梯口 ESCALATOR=扶梯口 STAIR=楼梯口 SPACE_ENTRY=车位入口 SHOP_ENTRY=商铺入口 POI_ENTRY=设施入口")
