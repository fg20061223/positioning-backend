 ...
 */
@Schema(description = "导航历史表: 记录用户每次导航的起终点、路径与耗时")
@Data
@TableName("nav_history")
public class NavHistory {

    /** 导航记录ID（雪花ID，应用层生成） */
    @Schema(description = "导航记录ID（雪花ID，应用层生成）")
    ...
    @Schema(description = "起点类型: CURRENT_POSITION=当前位置 SPACE=车位 SHOP=商铺 POI=设施")
    private String fromType;

    /** 起点目标ID */
    @Schema(description = "起点目标ID")
    private Long fromTargetId;

    /** 终点类型: SPACE=车位 SHOP=商铺 POI=设施 */
    @Schema(description = "终点类型: SPACE=车位 SHOP=商铺 POI=设施")
    private String toType;

    /** 终点目标ID */
    @Schema(description = "终点目标ID")
    private Long toTargetId;

    /** 整条路径线（PostGIS几何, GeoJSON; 通用CRUD不读写, 走专门空间接口） */
    @Schema(description = "整条路径线（PostGIS几何, GeoJSON; 通用CRUD不读写, 走专门空间接口）")
    ...
    /** 导航耗时（秒） */
    @Schema(description = "导航耗时（秒）")
    private Integer durationS;

    /** 导航状态: FINISHED=完成 ABORTED=中途放弃 */
    @Schema(description = "导航状态: FINISHED=完成 ABORTED=中途放弃")
    private String status;

    /** 导航开始时间 */
    @Schema(description = "导航开始时间")
    private LocalDateTime startTime;

    /** 导航结束时间 */
    @Schema(description = "导航结束时间")
